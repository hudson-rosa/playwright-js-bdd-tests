...
# ios-deploy --id <UDID> --bundle ./apps/iOS-Real-Device-Saucelabs-MyDemo.1.3.0-162.ipa
...
# xcrun xcodebuild -exportArchive -archivePath ./apps/iOS-Simulator-Saucelabs-MyDemo.app/MyRNDemoApp.app -exportPath ./InstalledApp -exportOptionsPlist ExportOptions.plist